...
- Finalizado o material do curso, aqueles que quiserem certificado de conclusão, deverão abrir um issue no [repositório do Trilha - Dev](https://github.com/splor-mg/trilha-dev/), marcando o usuário `raianecardoso`, e indicando a url pública do site construído no decorrer do curso. Veja as orientações completas em [Certificação](../certificacao.md).
