...
- Finalizado o material do curso, aqueles que quiserem certificado de conclusão, deverão abrir um issue no reposiório do Trilha - Dev, marcando o usuário `raianecardoso`, e indicando a url pública do site construído no decorrer do curso. Veja as orientações completas em [Certificação](../certificacao.md).
